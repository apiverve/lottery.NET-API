...
namespace APIVerve
{
    public class LotteryNumbersAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/lottery";
        ...
        public LotteryNumbersAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public LotteryNumbersAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, LotteryNumbersQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(LotteryNumbersQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(LotteryNumbersQueryOptions options)
        {
